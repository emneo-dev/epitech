...
namespace nts {
    C4001::C4001()
        ...
        _components[0] = std::move(_factory.createComponent("CNOR"));
        _components[1] = std::move(_factory.createComponent("CNOR"));
        _components[2] = std::move(_factory.createComponent("CNOR"));
    ...
    void C4001::dump() const {
        ...
        std::cout << "pin " << std::setw(2) << getPin(5).id << " : " << std::setw(10) << print(getPin(5).state)
                  << " NOR pin " << std::setw(2) << getPin(6).id << " : " << std::setw(10) << print(getPin(6).state);
        ...
        std::cout << "pin " << std::setw(2) << getPin(8).id << " : " << std::setw(10) << print(getPin(8).state)
                  << " NOR pin " << std::setw(2) << getPin(9).id << " : " << std::setw(10) << print(getPin(9).state);
        ...
        std::cout << "pin " << std::setw(2) << getPin(12).id << " : " << std::setw(10) << print(getPin(12).state)
                  << " NOR pin " << std::setw(2) << getPin(13).id << " : " << std::setw(10) << print(getPin(13).state);
