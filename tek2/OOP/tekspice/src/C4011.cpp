...
namespace nts {
    C4011::C4011()
        ...
        _components[0] = std::move(_factory.createComponent("CNAND"));
        _components[1] = std::move(_factory.createComponent("CNAND"));
        _components[2] = std::move(_factory.createComponent("CNAND"));
        _components[3] = std::move(_factory.createComponent("CNAND"));
    ...
    void C4011::dump() const {
        ...
        std::cout << "pin " << std::setw(2) << getPin(1).id << " : " << std::setw(10) << print(getPin(1).state)
                  << " NAND pin " << std::setw(2) << getPin(2).id << " : " << std::setw(10) << print(getPin(2).state);
        ...
        std::cout << "pin " << std::setw(2) << getPin(5).id << " : " << std::setw(10) << print(getPin(5).state)
                  << " NAND pin " << std::setw(2) << getPin(6).id << " : " << std::setw(10) << print(getPin(6).state);
        ...
        std::cout << "pin " << std::setw(2) << getPin(8).id << " : " << std::setw(10) << print(getPin(8).state)
                  << " NAND pin " << std::setw(2) << getPin(9).id << " : " << std::setw(10) << print(getPin(9).state);
        ...
        std::cout << "pin " << std::setw(2) << getPin(12).id << " : " << std::setw(10) << print(getPin(12).state)
                  << " NAND pin " << std::setw(2) << getPin(13).id << " : " << std::setw(10) << print(getPin(13).state);
