...
namespace nts {
    ...
    void C4071::dump() const {
        ...
        std::cout << "pin " << std::setw(2) << getPin(5).id << " : " << std::setw(10) << print(getPin(5).state)
                  << " OR pin " << std::setw(2) << getPin(6).id << " : " << std::setw(10) << print(getPin(6).state);
        ...
        std::cout << "pin " << std::setw(2) << getPin(8).id << " : " << std::setw(10) << print(getPin(8).state)
                  << " OR pin " << std::setw(2) << getPin(9).id << " : " << std::setw(10) << print(getPin(9).state);
        ...
        std::cout << "pin " << std::setw(2) << getPin(12).id << " : " << std::setw(10) << print(getPin(12).state)
                  << " OR pin " << std::setw(2) << getPin(13).id << " : " << std::setw(10) << print(getPin(13).state);
